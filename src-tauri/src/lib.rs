...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::credits::add_patient_credit,
            commands::credits::get_patient_credit,
            commands::credits::list_credit_movements,
            commands::credits::apply_credit_to_invoice,
            commands::credits::refund_patient_credit,
            commands::rewards::create_prize,
            commands::rewards::update_prize,
            commands::rewards::delete_prize,
            commands::rewards::list_prizes,
            commands::rewards::spin_wheel,
            commands::rewards::list_patient_prizes,
            commands::rewards::list_pending_prizes,
            commands::rewards::redeem_prize,
