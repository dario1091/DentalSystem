  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <p className="text-sm text-gray-500">
        Busque un paciente para ver o crear su historia clínica. También puede acceder desde la vista
        de detalle del paciente, pestaña "Historia Clínica".
      </p>
      ...
      {results.length > 0 && (
        <div className="space-y-2">
          {results.map((patient) => (
            <button
              key={patient.id}
              onClick={() => navigate(`/patients/${patient.id}?tab=history`)}
