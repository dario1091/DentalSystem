...
const navItems: NavItem[] = [
  ...
  { to: "/odontogram", label: "Odontograma", icon: <Activity size={20} /> },
  { to: "/clinical-history", label: "Historia Clínica", icon: <FileText size={20} /> },
  { to: "/documents", label: "Documentos", icon: <FolderOpen size={20} /> },
